import requests
#根据学科标签
subject=["math","english","chinese","physics","chemistry"]
for key in subject:
    url1 = 'https://zhihuotech.com/bank/questionManage/listTopicBySubjectEn/{}'
    header = {'Accept': '*/*',
    ...
    r = requests.get(url=url1.format(key), headers=header, params=None,verify=False)
