...
#题量计算
url='https://bi.zhihuotech.com/logtool-dev/logTool/insight_question/search_data'
header={
...
form_data={"book_id":"506","chose_id_list":[],"custom_question_type":[],"page_num":1,"page_size":2,"part_type":0,"position_ids":[],"question_type":1,"search_name":""}
